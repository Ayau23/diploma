            ...
            _authorizeClient(
              ...
              },
              {
                onSuccess: authorized => {
                  ...
                  localStorage.setItem('refreshToken', registered.refresh_token)
                  addUser({
                    pick: 'client',
                    id: authorized.id,
                    email: data.email,
              ...
              <div className='flex gap-x-3 mt-7 '>
                ...
                <div onClick={() => setIsNotify(prevState => !prevState)}>
                  ...
                  <span className='text-[10px] leading-[13px] inline-block mt-2'>
                    We will send special offers and promotions to your email.
                    You can unsubscribe from the mailing list at any time. You
                    can find out more in the privacy policy.
